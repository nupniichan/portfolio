...
export default function Home() {
  return (
    <div className="flex min-h-screen items-center justify-center p-4 sm:p-6 md:p-12 lg:p-24">
      <div className="w-full max-w-[95%] sm:max-w-[90%] md:max-w-[85%] lg:max-w-[80%] xl:max-w-[75%] bg-black/50 border border-white/20 rounded-[20px] backdrop-blur-xs p-4 sm:p-6 md:p-8 shadow-[0_8px_32px_0_rgba(31,38,135,0.37)] floating-container">
